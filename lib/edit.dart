...
class _EditState extends State<Edit> with MyStyle {
        ...
        Center(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                NewTextField(
                  text: widget.edit_row["tc"].toString(),
                  maxLine: 11,
                  password: false,
                ...
                NewTextField(
                  text: widget.edit_row["name"].toString(),
                  password: false,
                  controller: ad,
                ),
                SizedBox(height: 10),
                NewTextField(
                  text: widget.edit_row["lastname"].toString(),
                  password: false,
                  controller: soyad,
                ),
                TextField(
                  ...
                  decoration: InputDecoration(
                      hintText: widget.edit_row["password"].toString(),
                      prefixText: ' ',
                      suffix: IconButton(
                        onPressed: () {
                          _change(isSelect);
                ...
                ElevatedButton(
                    onPressed: () async {
                      ...
                      await db.update("kisiler", veriler,
                          where: "id=?", whereArgs: ["tc"]);
